class AddManagementPracticesToBiodiversitySurveys < ActiveRecord::Migration[6.0]
  def change
    ...
    add_column :biodiversity_surveys, :no_soil_health_measures, :boolean, default: false
    ...
    add_column :biodiversity_surveys, :no_organic_matter, :boolean, default: false
    ...
    add_column :biodiversity_surveys, :no_grassland_measures, :boolean, default: false
    ...
    add_column :biodiversity_surveys, :no_hedgerows, :boolean, default: false
    ...
    add_column :biodiversity_surveys, :no_water_courses, :boolean, default: false
